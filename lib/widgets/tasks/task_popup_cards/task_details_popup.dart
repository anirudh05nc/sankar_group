...
class TaskDetailsPopup extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (task.status == 'pending') {
      ...
      statusText = 'Pending ($daysLeft)';
    } else if (task.status == 'ongoing') {
      statusColor = theme.blueColor;
      statusText = 'OnGoing ($daysLeft)';
    } else if (task.status.startsWith('completed')) {
      statusColor = theme.greenColor;
      statusText = 'Completed ($daysLeft)';
    } else {
      statusColor = theme.greenColor;
      statusText = 'Completed ($daysLeft)';
    }
                ...
                children: [
                  ...
                  _buildActionIcon(
                    ...
                    onTap: () {
                      ...
                      // Edit implementation can be added here
                    },
                  ),
                  if (task.status != 'pending')
                    _buildActionIcon(
